...
/**
 * SearchParamsModificationsData Class Doc Comment
 *
 * @category Class
 * @package  WheelSizeApiClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SearchParamsModificationsData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SearchParamsModificationsData';
    ...
    protected static $swaggerTypes = [
        ...
        'trim_levels' => 'string',
        'model' => '\WheelSizeApiClient\Model\TireCar',
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) < 1)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling SearchParamsModificationsData., must be bigger than or equal to 1.');
        }
     ...
     * Gets model
     *
     * @return \WheelSizeApiClient\Model\TireCar
     */
     ...
     * Sets model
     *
     * @param \WheelSizeApiClient\Model\TireCar $model model
     *
     * @return $this
     */
