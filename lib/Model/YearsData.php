 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class YearsData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'YearsData';
     ...
     * Sets slug
     *
     * @param int $slug Same as *`name`*. Aimed to match general for this API slug-name format
     *
     * @return $this
     */
