...
/**
 * MakesDataBase Class Doc Comment
 *
 * @category Class
 * @package  WheelSizeApiClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MakesDataBase implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MakesDataBase';
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) < 1)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling MakesDataBase., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[-a-zA-Z0-9_]+$/", $slug))) {
            throw new \InvalidArgumentException("invalid value for $slug when calling MakesDataBase., must conform to the pattern /^[-a-zA-Z0-9_]+$/.");
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling MakesDataBase., must be bigger than or equal to 1.');
        }
    ...
    public function setNameEn($name_en)
    {
        ...
        if ((mb_strlen($name_en) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name_en when calling MakesDataBase., must be bigger than or equal to 1.');
        }
