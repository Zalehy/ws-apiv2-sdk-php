 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TireMake implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TireMake';
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) < 1)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling TireMake., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TireMake., must be bigger than or equal to 1.');
        }
    ...
    public function setNameEn($name_en)
    {
        ...
        if ((mb_strlen($name_en) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name_en when calling TireMake., must be bigger than or equal to 1.');
        }
