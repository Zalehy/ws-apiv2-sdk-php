...
/**
 * BoltPatternData Class Doc Comment
 *
 * @category Class
 * @package  WheelSizeApiClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BoltPatternData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BoltPatternData';
     ...
     * Sets value
     *
     * @param string $value Value (e.g. `19.0`)
     *
     * @return $this
     */
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling BoltPatternData., must be bigger than or equal to 1.');
        }
