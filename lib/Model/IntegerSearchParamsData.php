...
/**
 * IntegerSearchParamsData Class Doc Comment
 *
 * @category Class
 * @package  WheelSizeApiClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IntegerSearchParamsData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IntegerSearchParamsData';
     ...
     * Sets value
     *
     * @param int $value Value (e.g. `19.0`)
     *
     * @return $this
     */
