...
/**
 * TiresVoteComAPIApi Class Doc Comment
 *
 * @category Class
 * @package  WheelSizeApiClient
 * @author   Swagger Codegen team
...
class TiresVoteComAPIApi
{
    ...
    {
        $this->tiresWithHttpInfo();
    }

    /**
     * Operation tiresWithHttpInfo
     *
     * false
     *
     *
     ...
     */
    public function tiresWithHttpInfo()
    {
        $returnType = '';
        $request = $this->tiresRequest();
     ...
     */
    public function tiresAsync()
    {
        return $this->tiresAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation tiresAsyncWithHttpInfo
     *
     * false
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tiresAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->tiresRequest();
    ...
    /**
     * Create request for operation 'tires'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function tiresRequest()
    {
