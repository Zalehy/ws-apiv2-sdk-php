...
/**
 * ServiceMethodsApi Class Doc Comment
 *
 * @category Class
 * @package  WheelSizeApiClient
 * @author   Swagger Codegen team
...
class ServiceMethodsApi
{
     ...
     * @return \WheelSizeApiClient\Model\RegionsReportOutput
     */
    public function regions()
    {
        list($response) = $this->regionsWithHttpInfo();
        return $response;
    }
     ...
     * @throws \WheelSizeApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \WheelSizeApiClient\Model\RegionsReportOutput, HTTP status code, HTTP response headers (array of strings)
     */
    public function regionsWithHttpInfo()
    {
        $returnType = '\WheelSizeApiClient\Model\RegionsReportOutput';
        $request = $this->regionsRequest();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WheelSizeApiClient\Model\RegionsReportOutput',
     ...
     */
    public function regionsAsync()
    {
        return $this->regionsAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function regionsAsyncWithHttpInfo()
    {
        $returnType = '\WheelSizeApiClient\Model\RegionsReportOutput';
        $request = $this->regionsRequest();
     ...
     */
    protected function regionsRequest()
    {
